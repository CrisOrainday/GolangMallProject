...
type RPCClient interface {
	...
	LoginRegister(ctx context.Context, Req *user.LoginReq, callOptions ...callopt.Option) (r *user.LoginResp, err error)
}
...
func (c *clientImpl) LoginRegister(ctx context.Context, Req *user.LoginReq, callOptions ...callopt.Option) (r *user.LoginResp, err error) {
	return c.kitexClient.LoginRegister(ctx, Req, callOptions...)
}
