...
var file_user_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x05, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x32, 0xa2, 0x01, 0x0a, 0x0b,
	...
	0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x32, 0x0a, 0x0d,
	0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x0e, 0x2e,
...
var file_user_proto_depIdxs = []int32{
	...
	2, // 2: user.UserService.LoginRegister:input_type -> user.LoginReq
	1, // 3: user.UserService.Register:output_type -> user.RegisterResp
	3, // 4: user.UserService.Login:output_type -> user.LoginResp
	3, // 5: user.UserService.LoginRegister:output_type -> user.LoginResp
...
type UserService interface {
	...
	LoginRegister(ctx context.Context, req *LoginReq) (res *LoginResp, err error)
}
